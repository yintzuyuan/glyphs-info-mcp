## [Previewing & Testing](#previewing-and-testing)

### [Previewing Kerning](#previewing-kerning)

Kerning can be previewed with three modes: no kerning ![](https://handbook.glyphsapp.com/v/content/icons/kerning-disabled.svg), kerning ![](https://handbook.glyphsapp.com/v/content/icons/kerning.svg), and locked kerning ![](https://handbook.glyphsapp.com/v/content/icons/kerning-no-spacing.svg).
See [Kerning Modes](https://handbook.glyphsapp.com/single-page/#kerning/modes "Spacing & Kerning ⯈ Kerning ⯈ Kerning Modes") for details.

### [Previewing Masters](#previewing-masters)
...
![](https://handbook.glyphsapp.com/v/content/images/root/master-picker.svg)
...
For more details on working with multiple font masters, see [Interpolation](https://handbook.glyphsapp.com/single-page/#interpolation "Interpolation").

### [Previewing OpenType Features](#previewing-opentype-layout)

![](https://handbook.glyphsapp.com/v/content/images/root/features-menu.png)
...
For details, see [Previewing in Adobe Applications](https://handbook.glyphsapp.com/single-page/#previewing-in-adobe-applications "Edit View ⯈ Previewing & Testing ⯈ Previewing in Adobe Applications").
Note that in InDesign, the OpenType features may be interpreted differently by different composers.

### [Previewing Interpolated Instances](#previewing-interpolated-instances)

Click the Preview button ![(an eye)](https://handbook.glyphsapp.com/v/content/icons/preview-eye.svg) in the bottom-left of the window to preview font instances.
...
Toggle the display of individual instances in `Show All Instances` by clicking the eye ![](https://handbook.glyphsapp.com/v/content/icons/visible.svg)/![](https://handbook.glyphsapp.com/v/content/icons/invisible.svg) icon next to an instance name.
...
Switch between black-on-white and white-on-black with the Invert ![](https://handbook.glyphsapp.com/v/content/icons/invert.svg) button next to the instances pop-up menu.
With the Flip ![](https://handbook.glyphsapp.com/v/content/icons/flip-vertical.svg)/![](https://handbook.glyphsapp.com/v/content/icons/flip-vertical-flipped.svg) button, flip the Preview upside-down.
...
### [Previewing on macOS](#previewing-on-macos)
...
### [Previewing in Adobe Applications](#previewing-in-adobe-applications)
...
### [Previewing in Web Browsers](#previewing-in-web-browsers)
...
Open the Palette sidebar with the sidebar button ![](https://handbook.glyphsapp.com/v/content/icons/sidebar-right.svg) in the top-right corner of the window, or choose `Window → Palette` (`Cmd-Opt-P`).
Glyphs includes four sections: `Dimensions`, `Fit Curve`, `Layers`, and `Transformations`.
Plug-ins can [add additional sections to the Palette](https://handbook.glyphsapp.com/single-page/#plugins "Extensions ⯈ Plug-ins").
