...
### [Magnetic Guides](#guides/magnetic)

![](https://handbook.glyphsapp.com/v/content/images/root/magnetic-guide.svg)
...
### [Local & Global Guides](#guides/local)
...
Quickly create a guide using the Measurement tool ![](https://handbook.glyphsapp.com/v/content/icons/measurement-tool-secondary.svg) by simultaneously holding down `Cmd-Opt-Ctrl` and pressing the `G` key after starting to drag a measurement line.

A local horizontal guide ![](https://handbook.glyphsapp.com/v/content/icons/guide-local-horizontal.svg) will be added at the click position.
...
Double-click the knob to turn it perpendicular ![](https://handbook.glyphsapp.com/v/content/icons/guide-local-vertical.svg) to its current orientation.
...
Global guides ![](https://handbook.glyphsapp.com/v/content/icons/guide-global-horizontal.svg) are red and visible throughout a master.
...
A locked guide cannot be selected and displays a lock ![](https://handbook.glyphsapp.com/v/content/icons/guide-local-horizontal-locked.svg)/![](https://handbook.glyphsapp.com/v/content/icons/guide-global-horizontal-locked.svg) icon instead of its knob.
...
![](https://handbook.glyphsapp.com/v/content/images/root/guides.svg)
...
![](https://handbook.glyphsapp.com/v/content/images/root/info-box-guide.svg)
...
Click the lock ![](https://handbook.glyphsapp.com/v/content/icons/lock-locked.svg) icon next to the angle in the Info box to maintain the guide at the set angle until the angle is unlocked ![](https://handbook.glyphsapp.com/v/content/icons/lock-unlocked.svg) again.

By default, a guide will be positioned relative to the left sidebearing.
Click ![the right-pointing arrow from a bar](https://handbook.glyphsapp.com/v/content/icons/alignment-right.svg) in the Info box to position it relative to the right sidebearing or ![arrow pointing left and right from a bar](https://handbook.glyphsapp.com/v/content/icons/alignment-center.svg) to position it relative to both sidebearings.
Click ![the left-pointing arrow from a bar](https://handbook.glyphsapp.com/v/content/icons/alignment-left.svg) to use the left sidebearing again.
This can be useful for slanted guides, especially when they are global or frequently changing the right side.

Select a guide and click the measurement ![](https://handbook.glyphsapp.com/v/content/icons/measurement-tool-secondary.svg) icon in the Info box to turn the guide into a measurement guide.
For more details, see [Measurement Guides](https://handbook.glyphsapp.com/single-page/#measuring/guides "Edit View ⯈ Measuring ⯈ Measurement Guides").
...
![](https://handbook.glyphsapp.com/v/content/images/root/guides-named.svg)
...
The rules for defining the scope of a global guide work the same as [Smart Filters](https://handbook.glyphsapp.com/single-page/#filtering/smart-filters "Font View ⯈ Filtering Font View ⯈ Smart Filters").

### [Glyph-Specific Undo History](#glyph-specific-undo-history)
