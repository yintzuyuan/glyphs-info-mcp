## [Segment Components](#components/segment)

![](https://handbook.glyphsapp.com/v/content/images/root/component-segment-application.svg)
...
### [Creating Segment Glyphs](#components/segment/creating)

![](https://handbook.glyphsapp.com/v/content/images/root/component-segment-setup.svg)
...
### [Using Segment Components](#using-segment-components)
...
Click the arrow ![](https://handbook.glyphsapp.com/v/content/icons/follow-link.svg) button to add and activate the segment glyph in Edit View.