## [Setting up Masters](#interpolation/masters)

![](https://handbook.glyphsapp.com/v/content/images/root/font-info-multiple-master-setup.png)

Interpolation requires at least two masters.
Add masters in `File → Font Info… → Masters`.
Click the plus ![](https://handbook.glyphsapp.com/v/content/icons/plus-button.svg) button located in the bottom-left of the window to add a new master.
...
Give each master a descriptive name such as *Light*, *Regular Condensed*, or *Bold Caption*, and pick a [representative master icon](https://handbook.glyphsapp.com/single-page/#masters/general "Font Info ⯈ Masters ⯈ General").

### [Axes Coordinates](#interpolation/axes-coordinates)
...
See [Axis Location](https://handbook.glyphsapp.com/single-page/#axis-location "Interpolation ⯈ Variable Font Options ⯈ Axis Location") for details.
...
See [Axis Mappings](https://handbook.glyphsapp.com/single-page/#axis-mappings "Interpolation ⯈ Variable Font Options ⯈ Axis Mappings") for details.

### [Minimal Multiple Masters Setup](#interpolation/masters/minimal-multiple-masters-setup)
...
See [Variable Font Origin](https://handbook.glyphsapp.com/single-page/#variable-font-origin "Interpolation ⯈ Variable Font Options ⯈ Variable Font Origin") for information on choosing the origin master.
...
### [Elaborate Multiple Masters Setups](#interpolation/masters/elaborate-multiple-masters-setups)
