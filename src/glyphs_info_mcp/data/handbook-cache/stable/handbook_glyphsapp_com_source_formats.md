...
Plug-ins can add support for additional source formats; see [Plug-ins](https://handbook.glyphsapp.com/single-page/#plugins "Extensions ⯈ Plug-ins").

Pick the source file format when saving with `File → Save As…` (`Cmd-Shift-S`).
Each format is described in the following sections.

### [Glyphs File](#source-formats/glyphs)
...
A Glyphs file is *flat*, meaning it is stored as a single file containing all information about the font.
...
See also [File Format Version](https://handbook.glyphsapp.com/single-page/#file-format-version "Font Info ⯈ Other Settings ⯈ File Format Version").

### [Glyphs File Package](#source-formats/glyphs-package)
...
### [Unified Font Object](#source-formats/ufo)

The *UFO* format is available both as a source file format and [as an export format](https://handbook.glyphsapp.com/single-page/#export/ufo "Import & Export ⯈ Exporting Font Files ⯈ Exporting UFO").
...
The results of the specialized tool can then be imported into the Glyphs file, for instance, by [importing metrics](https://handbook.glyphsapp.com/single-page/#import/metrics "Import & Export ⯈ Importing Font Data ⯈ Importing Metrics").

See [Font File Importing Behaviors](https://handbook.glyphsapp.com/single-page/#import/behaviors "Import & Export ⯈ Opening Font Files ⯈ Font File Importing Behaviors") for file import configuration options.
Configure these options for a specific UFO file in `File → Font Info… → Other`; see [Use Custom Naming](https://handbook.glyphsapp.com/single-page/#use-custom-naming "Font Info ⯈ Other Settings ⯈ Use Custom Naming") and [Disable Automatic Alignment](https://handbook.glyphsapp.com/single-page/#disable-automatic-alignment "Font Info ⯈ Other Settings ⯈ Disable Automatic Alignment").