...
![](https://handbook.glyphsapp.com/v/content/images/root/plugin-manager.png)
...
Some extension vendors accept donations via ![](https://handbook.glyphsapp.com/v/content/icons/donation-paypal.svg) PayPal and ![](https://handbook.glyphsapp.com/v/content/icons/donation-ko-fi.svg) Ko-fi.
Click the icon to open the donation page.

New extensions are added regularly to the Plugin Manager.
Open a pull request at the [Glyphs plug-in repository](https://github.com/schriftgestalt/glyphs-packages) to add a new entry or contact the Glyphs team [on the Glyphs forum](https://forum.glyphsapp.com) or [directly per email](https://glyphsapp.com/contact).
See [Creating Scripts](https://handbook.glyphsapp.com/single-page/#scripts/create "Extensions ⯈ Scripts ⯈ Creating Scripts") and [Creating Plug-ins](https://handbook.glyphsapp.com/single-page/#plugins/create "Extensions ⯈ Plug-ins ⯈ Creating Plug-ins") for details on creating new extensions.

Plugin Manager lists extensions from the main repository, accessible to all users.
Add alternative repositories as described in [Alternate Plugin Repositories](https://handbook.glyphsapp.com/single-page/#settings/addons/alternate-plugin-repositories "Settings ⯈ Addons ⯈ Alternate Plugin Repositories").
