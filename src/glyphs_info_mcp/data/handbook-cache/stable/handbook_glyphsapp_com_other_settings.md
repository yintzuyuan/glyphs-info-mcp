...
### [Grid Spacing & Subdivision](#grid-spacing-and-subdivision)
...
### [Keyboard Increments](#keyboard-increments)
...
### [Use Custom Naming](#use-custom-naming)
...
Go to `Settings → User Settings` to change the setting of the option `Keep Glyph Names from Imported Files` (see [User Settings](https://handbook.glyphsapp.com/single-page/#settings/user-settings "Settings ⯈ User Settings")).
...
Go to `Glyphs → Settings… → User Settings → Disable Automatic Alignment for Imported Files` for the setting of imported files (see [User Settings](https://handbook.glyphsapp.com/single-page/#settings/user-settings "Settings ⯈ User Settings")).
See also [Automatic Alignment](https://handbook.glyphsapp.com/single-page/#automatic-alignment "Reusing Shapes ⯈ Components ⯈ Automatic Alignment").

### [Keep Alternates Next to Base Glyph](#keep-alternates-next-to-base-glyph)
