...
### [Creating Strokes](#graphic-attributes/strokes)

**Left:** an open path   
**Center:** the path with a stroke   
**Right:** the expanded outline

![](https://handbook.glyphsapp.com/v/content/images/root/stroke-path.svg)
...
The stroke width (`W`) and stroke height (`H`) are measured in font units.
If no height is set, then the width is used for both dimensions.
Below the width and height fields are controls for the stroke placement (![](https://handbook.glyphsapp.com/v/content/icons/line-align-center.svg) along the path, ![](https://handbook.glyphsapp.com/v/content/icons/line-align-left.svg) to the left of the path, ![](https://handbook.glyphsapp.com/v/content/icons/line-align-right.svg) to the right of the path) and controls for the stroke ends (![flat](https://handbook.glyphsapp.com/v/content/icons/line-cap-style-butt.svg), ![square](https://handbook.glyphsapp.com/v/content/icons/line-cap-style-square.svg), ![round](https://handbook.glyphsapp.com/v/content/icons/line-cap-style-round.svg), ![round inset](https://handbook.glyphsapp.com/v/content/icons/line-cap-style-round-inset.svg), ![aligned to an axis](https://handbook.glyphsapp.com/v/content/icons/line-cap-style-align-to-axis.svg)).
...
### [Masking](#graphic-attributes/path-masking)
...
![](https://handbook.glyphsapp.com/v/content/images/root/mask-path.svg)
