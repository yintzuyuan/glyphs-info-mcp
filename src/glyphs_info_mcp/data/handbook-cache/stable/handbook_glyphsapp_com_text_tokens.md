...
A key path is an expression that uses the [Core API](https://docu.glyphsapp.com/Core) to access values of a font (`GSFont`) or instance (`GSInstance`).
...
See [Number Values](https://handbook.glyphsapp.com/single-page/#masters/number-values "Font Info ⯈ Masters ⯈ Number Values") for details.
...
See [Glyph Property Tokens](https://handbook.glyphsapp.com/single-page/#layout/tokens/glyph-property "Feature Code ⯈ Tokens ⯈ Glyph Property Tokens") for details.