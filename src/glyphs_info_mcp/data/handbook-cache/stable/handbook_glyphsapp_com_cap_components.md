## [Cap Components](#components/cap)

![](https://handbook.glyphsapp.com/v/content/images/root/component-cap-top-bottom.svg)

Cap components attach to two nodes.
This is in contrast to [corner components](https://handbook.glyphsapp.com/single-page/#components/corner "Reusing Shapes ⯈ Corner Components"), which attach to a single node.
...
### [Creating Cap Glyphs](#components/cap/creating)
...
![](https://handbook.glyphsapp.com/v/content/images/root/component-cap-setup.svg)
...
### [Using Cap Components](#components/cap/usage)
...
![](https://handbook.glyphsapp.com/v/content/images/root/info-box-component-cap-fit.svg)

Check the `Fit` checkbox to automatically match the size of the cap to the size of the stroke to which it is attached.
Cap components can be replaced, transformed, and aligned like [corner components](https://handbook.glyphsapp.com/single-page/#components/corner/usage "Reusing Shapes ⯈ Corner Components ⯈ Using Corner Components").