...
![](https://handbook.glyphsapp.com/v/content/images/root/settings-sharing.png)

Glyphs can stream the current Edit View to a second display such as an iPhone, iPad, or iPod Touch.
Choose `Enable External Preview` and download the *Glyphs Viewer* app [from the App Store](https://appstore.com/schriftgestaltungde/glyphsviewer) or search for `Glyphs Viewer`.
