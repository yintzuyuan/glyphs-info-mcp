## [Importing Font Data](#import/font-data)

### [Importing Outlines](#import/outlines)
...
![](https://handbook.glyphsapp.com/v/content/images/root/import-outlines-alert-glyph-not-found.png)
...
For PDF files, the stroke thickness is imported as a [stroke style](https://handbook.glyphsapp.com/single-page/#graphic-attributes/strokes "Edit View ⯈ Graphic Attributes ⯈ Creating Strokes").

See [Vector Drawing Applications](https://handbook.glyphsapp.com/single-page/#import-export/vector-drawing-applications "Import & Export ⯈ Vector Drawing Applications") for information on importing outlines with copy and paste.

### [Importing Metrics](#import/metrics)

Glyphs can import the spacing and kerning of a master from *Metrics* and *AFM* files (both of which can be exported from Glyphs, see [Exporting Metrics](https://handbook.glyphsapp.com/single-page/#export/metrics "Import & Export ⯈ Exporting Font Files ⯈ Exporting Metrics")) and from Glyphs and UFO files.
...
![](https://handbook.glyphsapp.com/v/content/images/root/import-metrics-dialog.png)
...
Import kerning values from one Glyphs file into another by copying and pasting them in the Kerning window (`Window → Kerning`, `Cmd-Opt-K`, see [Kerning Window](https://handbook.glyphsapp.com/single-page/#kerning/window "Spacing & Kerning ⯈ Kerning ⯈ Kerning Window") for details).
...
### [Importing Feature Files](#import/feature-files)
...
See [Features](https://handbook.glyphsapp.com/single-page/#layout "Font Info ⯈ Features") for details on OpenType features.