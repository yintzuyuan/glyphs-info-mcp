...
![](https://handbook.glyphsapp.com/v/content/images/root/smart-arrow.svg)

Smart components allow for variation of design properties within a single component glyph.
Each smart component can have its own set of variation properties such as *width*, *height*, *angle*, *roundness*, or any other arbitrary design feature that can vary along an axis.
...
### [Setting up Smart Glyphs](#components/smart/setup)

![](https://handbook.glyphsapp.com/v/content/images/root/smart-glyph-layers.svg)

Above: The two layers of a `_part.arrow` smart glyph.
Below: The `Layers` palette for the smart glyph.

![](https://handbook.glyphsapp.com/v/content/images/root/smart-glyphs-layers-palette.svg)
...
The different forms of a smart glyph (for example, *Narrow* and *Wide* or *Sharp* and *Rounded*) are placed on smart layers.
Click the plus ![](https://handbook.glyphsapp.com/v/content/icons/plus.svg) button in the bottom-left of the `Layers` palette to create a new layer.
...
For more on layer compatibility, see [Outline Compatibility](https://handbook.glyphsapp.com/single-page/#interpolation/outline-compatibility "Interpolation ⯈ Outline Compatibility").
...
#### [Smart Glyph Properties Settings](#components/smart/settings/property)

![](https://handbook.glyphsapp.com/v/content/images/root/smart-glyph-settings-properties.png)

Create a new property by clicking the plus ![](https://handbook.glyphsapp.com/v/content/icons/plus.svg) button located in the bottom-left of the `Properties` tab.
...
The names `Width` and `Height` have a special meaning; see [Width & Height Properties](https://handbook.glyphsapp.com/single-page/#smart-components/size-properties "Reusing Shapes ⯈ Smart Components ⯈ Width & Height Properties") for details.
...
Note that smart components can be interpolated *and extrapolated*.
...
#### [Smart Glyph Layers Settings](#components/smart/settings/layer)

![](https://handbook.glyphsapp.com/v/content/images/root/smart-glyph-settings-layers.png)
...
### [Using Smart Components](#components/smart/usage)

Add a smart component like any other component (as described in [Building Composites](https://handbook.glyphsapp.com/single-page/#building-composites "Reusing Shapes ⯈ Components ⯈ Building Composites")).
...
![](https://handbook.glyphsapp.com/v/content/images/root/smart-component-dialog.png)
...
![](https://handbook.glyphsapp.com/v/content/images/root/smart-settings.svg)
...
Use the slider ![](https://handbook.glyphsapp.com/v/content/icons/slider.svg) to set the setting of a property anywhere from the minimum to the maximum value.
Use the number field to input any value, which might also extrapolate beyond the minimum and maximum values.
If the min/max values are 0/1, a checkbox ![](https://handbook.glyphsapp.com/v/content/icons/checkbox-checked.svg) is displayed instead.

### [Width & Height Properties](#smart-components/size-properties)

![](https://handbook.glyphsapp.com/v/content/images/root/smart-component-bounding-box-resize.svg)
