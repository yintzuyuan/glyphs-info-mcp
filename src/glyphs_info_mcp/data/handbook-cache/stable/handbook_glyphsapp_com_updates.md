...
![](https://handbook.glyphsapp.com/v/content/images/root/settings-updates.png)
...
Revert to the latest stable version of Glyphs by re-downloading it from [glyphsapp.com/buy](https://glyphsapp.com/buy).
Downloading a new version or reverting to an old version of Glyphs will *not* reset the settings.