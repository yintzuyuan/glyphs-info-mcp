...
Or activate the Zoom tool ![](https://handbook.glyphsapp.com/v/content/icons/zoom-tool.svg) (shortcut `Z`) and click on the canvas to zoom in, `Option`-click to zoom out.
...
![](https://handbook.glyphsapp.com/v/content/images/root/zoom-control-focused.png)

Or use the zoom ![minus](https://handbook.glyphsapp.com/v/content/icons/minus.svg) / ![plus](https://handbook.glyphsapp.com/v/content/icons/plus.svg) buttons in the bottom-right corner of the window.
...
Alternatively, switch to the Hand tool ![](https://handbook.glyphsapp.com/v/content/icons/hand-tool.svg) (shortcut `H`) and drag the canvas around, or simply hold down the `Space` bar to temporarily switch to the Hand tool.
...
:   displays the on-curve and off-curve points of a glyph.
    Control the display of points on the foreground layer, the [background layer](https://handbook.glyphsapp.com/single-page/#background "Edit View ⯈ Background"), and [Extra Nodes](https://handbook.glyphsapp.com/single-page/#extra-nodes "Reusing Shapes ⯈ Corner Components ⯈ Extra Nodes").
...
`Show Anchors`
:   shows the [anchors](https://handbook.glyphsapp.com/single-page/#anchors "Edit View ⯈ Anchors") of the current glyph.

`Show Info`
:   displays the [Info box](https://handbook.glyphsapp.com/single-page/#info-box "Edit View ⯈ Info Box") as well as contextual controls at the bottom of the Palette.

`Show Background`
:   displays the paths and components of the [background layer](https://handbook.glyphsapp.com/single-page/#background "Edit View ⯈ Background") as outlines in the foreground layer.

`Show Image`
:   shows [images](https://handbook.glyphsapp.com/single-page/#edit-view/images "Edit View ⯈ Images") placed on a glyph layer.

`Show Guides`
:   displays [local and global guides](https://handbook.glyphsapp.com/single-page/#guides "Edit View ⯈ Guides").

`Show Measurement Line`
:   shows horizontal and vertical [measurement lines](https://handbook.glyphsapp.com/single-page/#measuring/line "Edit View ⯈ Measuring ⯈ Measurement Line") with numbers for the amount of space between the glyphs.
    Only visible when the Text tool is active.

`Show Annotations`
:   shows annotations placed with the [Annotation tool](https://handbook.glyphsapp.com/single-page/#annotation-tool "Edit View ⯈ Annotating").

`Show Bounding Box`
:   displays the [bounding box](https://handbook.glyphsapp.com/single-page/#scaling-and-rotating "Edit View ⯈ Editing Paths ⯈ Scaling & Rotating") of a selection with transformation knobs on all four sides and corners.
...
:   fills closed paths with the foreground color.
    ...
    See [Appearance](https://handbook.glyphsapp.com/single-page/#settings/appearance "Settings ⯈ Appearance") for details.

Many third-party reporter plug-ins are available for changing or enhancing the glyph display in Edit View.
After [they are installed](https://handbook.glyphsapp.com/single-page/#plugins "Extensions ⯈ Plug-ins"), they will also show up in the `View` menu.

### [Glyph & Layer Colors](#glyph-and-layer-colors)
...
![](https://handbook.glyphsapp.com/v/content/images/root/shortcut-menu-light-green.png)
...
![](https://handbook.glyphsapp.com/v/content/images/root/glyph-cell-colors.svg)

![](https://handbook.glyphsapp.com/v/content/images/root/info-box-colors.svg)
...
See [Color Label](https://handbook.glyphsapp.com/single-page/#glyph/color-label "Font View ⯈ Glyph Properties ⯈ Color Label") for managing color labels in Font View.