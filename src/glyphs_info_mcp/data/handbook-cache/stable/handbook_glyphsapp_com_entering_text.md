...
Set the maximum line width [in the settings](https://handbook.glyphsapp.com/single-page/#settings/appearance "Settings ⯈ Appearance").

### [Text Tool](#text-tool)

Select the Text tool ![](https://handbook.glyphsapp.com/v/content/icons/text-tool.svg) (shortcut `T`) to switch to text mode and start typing.
...
#### [Find Glyphs to Insert](#find-glyphs-to-insert)

![](https://handbook.glyphsapp.com/v/content/images/root/find-glyph.png)
...
Click the magnifying glass ![](https://handbook.glyphsapp.com/v/content/icons/magnifying-glass-light.svg) to configure the search.
...
#### [Placeholder Glyphs](#placeholder-glyphs)
...
![](https://handbook.glyphsapp.com/v/content/images/root/writing-direction.svg)
...
![](https://handbook.glyphsapp.com/v/content/images/root/text-preview.png)
...
Click the magnifying glass ![](https://handbook.glyphsapp.com/v/content/icons/magnifying-glass-with-menu.svg) icon to set options for the search.
...
Click the pin ![](https://handbook.glyphsapp.com/v/content/icons/pin.svg) icon to toggle the pinned state of the window.
...
![](https://handbook.glyphsapp.com/v/content/images/root/sample-strings.png)

Edit and store [sample strings](https://handbook.glyphsapp.com/single-page/#settings/sample-strings "Settings ⯈ Sample Strings") in `Glyphs → Settings… → Sample Strings`.
...
Keyboard shortcuts to these commands can be assigned [in the settings](https://handbook.glyphsapp.com/single-page/#settings/shortcuts "Settings ⯈ Shortcuts").
Click the pin ![](https://handbook.glyphsapp.com/v/content/icons/pin.svg) button to keep the sample strings window open.