...
![](https://handbook.glyphsapp.com/v/content/images/root/settings-addons.png)

Glyphs can be extended with plug-ins, scripts, and modules from the [Plugin Manager](https://handbook.glyphsapp.com/single-page/#plugin-manager "Extensions ⯈ Plugin Manager").
The `Addons` settings control how these extensions work and which extensions are available.

### [Python version](#settings/addons/python-version)
...
### [Console Output](#settings/addons/console-output)
...
### [Alternate Plugin Repositories](#settings/addons/alternate-plugin-repositories)
...
For the file structure, reference the [main plug-in repository](https://github.com/schriftgestalt/glyphs-packages/blob/glyphs3/packages.plist).
...
See [the package index website](https://github.com/schriftgestalt/glyphs-packages) for a list of language codes.
