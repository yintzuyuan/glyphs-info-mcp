## [Names & Unicode](#glyph-names)

### [Glyph Info Database](#glyph-info-database)

Glyphs contains a glyph info database.
For each glyph, the database defines:

- the [nice glyph name](https://handbook.glyphsapp.com/single-page/#glyph/name "Font View ⯈ Glyph Properties ⯈ Glyph Name") that is used within Glyphs;
- the [production name](https://handbook.glyphsapp.com/single-page/#glyph/production-name "Font View ⯈ Glyph Properties ⯈ Production Name") that is used on export;
- the associated [Unicode value](https://handbook.glyphsapp.com/single-page/#glyph/unicode "Font View ⯈ Glyph Properties ⯈ Unicode"), when there is one;
- the [components](https://handbook.glyphsapp.com/single-page/#components "Reusing Shapes ⯈ Components"), in the case of composite glyphs;
- a default set of [anchors](https://handbook.glyphsapp.com/single-page/#anchors "Edit View ⯈ Anchors");
- the associated marks displayed in [the mark cloud](https://handbook.glyphsapp.com/single-page/#settings/appearance "Settings ⯈ Appearance");
- the [script](https://handbook.glyphsapp.com/single-page/#glyph/script "Font View ⯈ Glyph Properties ⯈ Script") of the glyph;
...
See [Glyph Name](https://handbook.glyphsapp.com/single-page/#glyph/name "Font View ⯈ Glyph Properties ⯈ Glyph Name") and [Production Name](https://handbook.glyphsapp.com/single-page/#glyph/production-name "Font View ⯈ Glyph Properties ⯈ Production Name") for details on both.
...
![](https://handbook.glyphsapp.com/v/content/images/root/glyph-info.png)

Use the methods described in [Glyph Properties](https://handbook.glyphsapp.com/single-page/#glyph "Font View ⯈ Glyph Properties") to override the glyph properties of individual glyphs for a single Glyphs file.
Adjust glyph properties for all Glyphs files by
[creating a custom `GlyphData.xml` file](https://glyphsapp.com/learn/roll-your-own-glyph-data).
...
See [Automatic Feature Generation](https://handbook.glyphsapp.com/single-page/#automatic-feature-generation "Appendix ⯈ Automatic Feature Generation") for details on how specific dot suffixes can help generate OpenType features, automatically.

### [Naming Glyphs](#glyph-names/introduction)

Glyph names appear underneath their glyph cell in [Grid View](https://handbook.glyphsapp.com/single-page/#grid-view "Font View ⯈ Viewing Glyphs ⯈ Grid View") or their column in [List View](https://handbook.glyphsapp.com/single-page/#list-view "Font View ⯈ Viewing Glyphs ⯈ List View").
...
See [Adding New Glyphs](https://handbook.glyphsapp.com/single-page/#glyph-set/adding "Font View ⯈ Managing the Glyph Set ⯈ Adding New Glyphs") for more details.
...
Using [a custom glyph info database](https://handbook.glyphsapp.com/single-page/#glyph-info-database "Font View ⯈ Names & Unicode ⯈ Glyph Info Database") can provide automated behavior like assigning Unicode values or categories based on glyph names.

Unicode-value-based glyph names start with `uni` followed by four hexadecimal digits or `u` followed by five or six digits.
See [Unicode](https://handbook.glyphsapp.com/single-page/#glyph/unicode "Font View ⯈ Glyph Properties ⯈ Unicode") for details.

### [Glyph Naming Rules](#glyph-names/rules)
...
![](https://handbook.glyphsapp.com/v/content/images/root/export-result-dialog-glyph-name-error.png)
...
See [Reusing Shapes: Components](https://handbook.glyphsapp.com/single-page/#components "Reusing Shapes ⯈ Components") for details on component glyphs and their naming rules.
...
Open the [Glyph Info window](https://handbook.glyphsapp.com/single-page/#glyph-info-database "Font View ⯈ Names & Unicode ⯈ Glyph Info Database") for all available script suffixes.
...
Alternate glyphs such as small caps and initial/medial/final forms use a dot suffix:
...
See [Automatic Feature Generation](https://handbook.glyphsapp.com/single-page/#automatic-feature-generation "Appendix ⯈ Automatic Feature Generation") for a list of all special glyph name suffixes.
...
### [Copy Glyph Names](#glyph-names/copying)
...
![](https://handbook.glyphsapp.com/v/content/images/root/copy-glyph-names.png)
...
### [Renaming Glyphs](#glyph-names/renaming)
...
See [Batch-Renaming Glyphs](https://handbook.glyphsapp.com/single-page/#batch-renaming-glyphs "Font View ⯈ Batch-Processing ⯈ Batch-Renaming Glyphs") for details on renaming multiple glyphs at once.

### [CID Mapping](#glyph-names/cid)
