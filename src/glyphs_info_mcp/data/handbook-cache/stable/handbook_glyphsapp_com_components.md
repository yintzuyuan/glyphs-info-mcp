...
![](https://handbook.glyphsapp.com/v/content/images/root/composite-Rcaron-next-to-R.svg)
...
The original glyph from which a component is derived is referred to as the *base glyph* of the component.
A glyph that is built out of components is referred to as a *compound* or *composite glyph*.
...
![](https://handbook.glyphsapp.com/v/content/images/root/composite-eacute-with-e-and-acutecomb.svg)
...
Glyphs uses the [glyph info database](https://handbook.glyphsapp.com/single-page/#glyph-info-database "Font View ⯈ Names & Unicode ⯈ Glyph Info Database") to figure out which components to insert into which glyphs.
...
See [Text Tool](https://handbook.glyphsapp.com/single-page/#text-tool "Edit View ⯈ Entering Text ⯈ Text Tool") for details.

### [Turning Paths into Components](#turning-paths-into-components)

![](https://handbook.glyphsapp.com/v/content/images/root/component-from-selection.png)

Create a new component by selecting paths and components on a glyph layer and choosing *Component from Selection* from the context menu or the `Glyph` menu.
...
See also the [exports glyph property](https://handbook.glyphsapp.com/single-page/#exports "Font Info ⯈ Exports").
...
![](https://handbook.glyphsapp.com/v/content/images/root/add-glyphs-recipes.png)
...
- base+mark=glyph, for example, `x+acutecomb=xacute`, which adds multiple components (separated by a plus sign) to a new glyph.
  The mark glyphs are automatically aligned to the base glyph using anchors.
- base+base=glyph, for example, `d+ezh.connect=dezh`.
  Adding multiple base components to a glyph can be useful when building ligatures.

### [Editing Components](#components/editing)

Click to select a component.
When dragging with the Select ![](https://handbook.glyphsapp.com/v/content/icons/select-tool.svg) tool, components are ignored unless the `Option` key is held down.
...
See [Edit View: Info Box](https://handbook.glyphsapp.com/single-page/#info-box "Edit View ⯈ Info Box") for details on the component Info box.

![](https://handbook.glyphsapp.com/v/content/images/root/gcommaaccent-with-g-and-commaaccentcomb.svg)

Transform components using the Info box, the [bounding box](https://handbook.glyphsapp.com/single-page/#scaling-and-rotating "Edit View ⯈ Editing Paths ⯈ Scaling & Rotating"), or the [Palette](https://handbook.glyphsapp.com/single-page/#palette/transformations "Palette ⯈ Transformations").
...
See [Automatic Alignment](https://handbook.glyphsapp.com/single-page/#automatic-alignment "Reusing Shapes ⯈ Components ⯈ Automatic Alignment") for details.
...
### [Moving between Base Glyphs and Composites](#moving-between-base-glyphs-and-composites)
...
Alternatively, click the arrow ![](https://handbook.glyphsapp.com/v/content/icons/follow-link.svg) button located in the top-left of the component Info box to edit its glyph.
...
### [Component Placeholders](#components/placeholders)

Component placeholders indicate a problem with a component.
There are three types of problems.

![](https://handbook.glyphsapp.com/v/content/images/root/component-placeholders.svg)
...
### [Anchors](#reusing-shapes/anchors)

Glyphs uses anchors for OpenType features (such as mark-to-base positioning and cursive attachment, see [Edit View: Anchors](https://handbook.glyphsapp.com/single-page/#anchors "Edit View ⯈ Anchors")) and for arranging components.
...
![](https://handbook.glyphsapp.com/v/content/images/root/Scaron-with-S-and-caroncomb.svg)
...
See [Adding, Editing, & Removing Anchors](https://handbook.glyphsapp.com/single-page/#anchors/adding "Edit View ⯈ Anchors ⯈ Adding, Editing, & Removing Anchors") for general information on working with anchors.
...
![](https://handbook.glyphsapp.com/v/content/images/root/info-box-component-with-anchor-picker.svg)

Switch between anchors by selecting an attached component and picking a different anchor from the ![anchor](https://handbook.glyphsapp.com/v/content/icons/anchor-picker.svg) menu in the component Info box.
...
See also [Disable Automatic Alignment](https://handbook.glyphsapp.com/single-page/#disable-automatic-alignment "Font Info ⯈ Other Settings ⯈ Disable Automatic Alignment").

![](https://handbook.glyphsapp.com/v/content/images/root/automatic-alignment-six-nine.svg)
...
For more information, see [Metrics Keys & Automatic Alignment](https://handbook.glyphsapp.com/single-page/#metrics-keys/automatic-alignment "Spacing & Kerning ⯈ Spacing ⯈ Metrics Keys & Automatic Alignment").
...
#### [Single Component](#components/single)

![](https://handbook.glyphsapp.com/v/content/images/root/mirrored-component.svg)
...
#### [Base Component & Mark Components](#components/base-mark)
...
![](https://handbook.glyphsapp.com/v/content/images/root/aringacute.svg)

Use anchors to place marks atop, below, or over the base component.
See [Components: Anchors](https://handbook.glyphsapp.com/single-page/#reusing-shapes/anchors "Reusing Shapes ⯈ Components ⯈ Anchors") for details.
...
Rearrange marks using the `Shape Order` filter (see [Shape Order](https://handbook.glyphsapp.com/single-page/#filters/shape-order "Filters ⯈ Built-in Filters ⯈ Shape Order")).
...
In such a case, either design a narrower macron and use that for the `imacron` or add additional space to the sidebearings of the composite glyph (see [Metrics Keys & Automatic Alignment](https://handbook.glyphsapp.com/single-page/#metrics-keys/automatic-alignment "Spacing & Kerning ⯈ Spacing ⯈ Metrics Keys & Automatic Alignment")).

See the [Diacritics tutorial](https://glyphsapp.com/learn/diacritics) for a guided introduction to working with diacritics.

#### [Multiple Base Components](#components/multiple-base)
...
![](https://handbook.glyphsapp.com/v/content/images/root/building-n-and-m-using-components-and-cursive-attachment-anchors.svg)

Base components can be connected using the same anchors that are used for [cursive attachment](https://handbook.glyphsapp.com/single-page/#cursive-attachment "Edit View ⯈ Anchors ⯈ Cursive Attachment").
...
See [Underscore Components](https://handbook.glyphsapp.com/single-page/#components/underscore-prefix "Reusing Shapes ⯈ Components ⯈ Underscore Components") for details on working with components with a name beginning with an underscore.

### [Locking Components](#components/locking)
...
### [Decomposing](#components/decomposing)
...
### [Combining Paths and Components](#combining-paths-and-components)
...
Instead, consider building the glyph from components only and connecting them with anchors as outlined in [Components: Anchors](https://handbook.glyphsapp.com/single-page/#reusing-shapes/anchors "Reusing Shapes ⯈ Components ⯈ Anchors"), thus enabling automatic alignment.
Consider defining glyphs as non-exporting if they are only ever used as parts of other glyphs.
See [Underscore Components](https://handbook.glyphsapp.com/single-page/#components/underscore-prefix "Reusing Shapes ⯈ Components ⯈ Underscore Components") and [Smart Components](https://handbook.glyphsapp.com/single-page/#components/smart "Reusing Shapes ⯈ Smart Components") for working with non-exporting components.
...
### [Nesting Components](#components/nesting)

![](https://handbook.glyphsapp.com/v/content/images/root/nested-components.svg)
...
### [Preferred Marks for Glyph Composition](#preferred-marks-for-glyph-composition)
...
### [Underscore Components](#components/underscore-prefix)
