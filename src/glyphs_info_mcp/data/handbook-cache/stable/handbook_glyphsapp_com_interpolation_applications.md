## [Interpolation Applications](#interpolation/applications)
...
In that case, there may be *Thin*, *Thin Condensed*, *Thin Expanded*, *Regular Narrow*, *Semibold Condensed*, and *Bold Expanded* instances.

Glyphs can also *extrapolate* static instances.
...
![](https://handbook.glyphsapp.com/v/content/images/root/interpolation-axes-demo.svg)
