...
class TestProtocolLoading:
    ...
    def test_load_glyphs_reporter_protocol(self, registry):
    ...
    def test_load_protocol_includes_optional_methods(self, registry):
    ...
    def test_load_protocol_filters_deprecated_methods(self, registry):
    ...
    def test_load_nonexistent_protocol(self, registry):
...
class TestPyObjCConversion:
    ...
    def test_convert_no_param_methods(self, registry):
    ...
    def test_convert_single_param_methods(self, registry):
    ...
    def test_convert_multi_param_methods(self, registry):
...
class TestCacheMechanism:
    ...
    def test_cache_protocol_methods(self, registry):
    ...
    def test_cache_different_protocols(self, registry):
...
class TestValidationTools:
    ...
    def test_validate_against_manual_list(self, registry):
    ...
    def test_validate_complete_manual_list(self, registry):
...
class TestMethodLookup:
    ...
    def test_get_method_info(self, registry):
    ...
    def test_get_method_info_nonexistent(self, registry):
    ...
    def test_is_protocol_method(self, registry):
...
class TestRealWorldCoverage:
    ...
    def test_coverage_completeness(self, registry):
    ...
    def test_includes_missing_methods_from_manual_list(self, registry):
