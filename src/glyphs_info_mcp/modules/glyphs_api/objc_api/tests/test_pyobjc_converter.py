...
class TestObjCToPython:
    ...
    def test_full_signature_with_return_type(self):
    ...
    def test_full_signature_multiple_params(self):
    ...
    def test_method_with_attributes(self):
    ...
    def test_method_with_semicolon(self):
...
class TestPythonToObjC:
    ...
    def test_with_param_count_validation(self):
    ...
    def test_trailing_underscores_removal(self):
...
class TestExtractMethodName:
    ...
    def test_extract_without_semicolon(self):
...
class TestFormatFullSignature:
    ...
    def test_format_no_param_instance_method(self):
    ...
    def test_format_single_param_instance_method(self):
    ...
    def test_format_multiple_params_instance_method(self):
    ...
    def test_format_param_count_mismatch(self):
        """Test error thrown when parameter count mismatch"""
...
class TestRoundTripConversion:
    ...
    def test_roundtrip_no_param(self):
    ...
    def test_roundtrip_single_param(self):
    ...
    def test_roundtrip_glyphs_method(self):
...
class TestRealWorldExamples:
    ...
    def test_reporter_protocol_methods(self):
    ...
    def test_filter_protocol_methods(self):
    ...
    def test_palette_protocol_methods(self):
