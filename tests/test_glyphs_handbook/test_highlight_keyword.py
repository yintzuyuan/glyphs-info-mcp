...
class TestHighlightKeyword:
    ...
    def test_highlights_all_occurrences_with_original_case(self):
    ...
    def test_partial_match_preserves_surrounding_text(self):
        """部分匹配時應保留周圍的文字"""
    ...
    def test_handles_empty_keyword(self):
        """空關鍵字應返回原文"""
        text = "Some text here."
    ...
    def test_multiple_same_case_occurrences(self):
        """多個相同大小寫的出現"""
