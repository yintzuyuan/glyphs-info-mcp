...
class TestMatchTypeWeights:
    ...
    def test_prefix_higher_than_contains(self):
        """前綴匹配應高於包含匹配"""
        from glyphs_info_mcp.shared.core.scoring_weights import MatchTypeWeights
...
class TestBackwardsCompatibility:
    ...
    def test_score_exact_match_equals_exact(self):
    ...
    def test_score_title_match_equals_title(self):
    ...
    def test_score_name_match_equals_name(self):
    ...
    def test_score_owner_match_equals_owner(self):
    ...
    def test_score_desc_match_equals_description(self):
...
class TestCodeStructureWeights:
    ...
    def test_class_exact_higher_than_contains(self):
        """類別精確匹配應高於包含匹配"""
    ...
    def test_method_weights_exist(self):
        """方法權重應存在"""
        from glyphs_info_mcp.shared.core.scoring_weights import CodeStructureWeights
...
class TestMultiWordWeights:
    ...
    def test_multi_word_bonus_exists(self):
        """多詞匹配加分應存在"""
    ...
    def test_partial_word_exists(self):
        """部分詞彙匹配權重應存在"""
        from glyphs_info_mcp.shared.core.scoring_weights import MultiWordWeights
