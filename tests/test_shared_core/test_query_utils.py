...
class TestTokenizeQuery:
    ...
    def test_filters_short_words_default(self):
        """預設過濾短於 2 字元的詞彙"""
        from glyphs_info_mcp.shared.core.query_utils import tokenize_query
    ...
    def test_filters_short_words_custom_length(self):
        """自訂最小詞彙長度"""
        from glyphs_info_mcp.shared.core.query_utils import tokenize_query
...
class TestCalculateMatchScore:
    ...
    def test_exact_match_with_case(self):
        """完全匹配（含大小寫）得最高分"""
...
class TestMinWordLength:
    ...
    def test_min_word_length_is_two(self):
