...
class TestPaginationInfo:
    ...
    def test_has_more_last_page_partial(self):
        """測試最後一頁只有部分結果"""
        pagination = PaginationInfo(
    ...
    def test_next_offset_with_more_results(self):
    ...
    def test_next_offset_last_page(self):
    ...
    def test_previous_offset_first_page(self):
    ...
    def test_previous_offset_second_page(self):
    ...
    def test_previous_offset_middle_page(self):
    ...
    def test_to_dict_last_page(self):
        """測試最後一頁轉換為字典"""
        pagination = PaginationInfo(
            total_count=100, offset=80, limit=20, current_count=20
        )
...
class TestPaginateResults:
    ...
    def test_paginate_negative_offset(self):
        """測試負數 offset 自動修正"""
        items = list(range(100))
    ...
    def test_paginate_limit_too_large(self):
    ...
    def test_paginate_limit_too_small(self):
        """測試 limit 小於 1"""
        items = list(range(100))
    ...
    def test_paginate_dict_list(self):
        """測試字典列表"""
