...
class TestVocabularyModulePluginsIntegration:
    ...
    def test_translate_select_tool_zh_to_en(self, module):
        """測試「選取工具」→ Select 翻譯"""
    ...
    def test_translate_select_en_to_zh(self, module):
        """測試 Select → 選取工具 翻譯"""
        # 先確認外掛詞彙已載入
    ...
    def test_search_ui_term_select_tool(self, module):
        """測試搜尋「選取工具」"""
    ...
    def test_fuzzy_find_select(self, module):
        """測試模糊搜尋 Select"""
    ...
    def test_reverse_term_map_includes_plugins(self, module):
        """測試反向索引包含外掛詞彙"""
        # 「選取工具」應該在反向索引中
    ...
    def test_plugins_accessor_initialized(self, module):
        """測試外掛存取器已初始化"""
    ...
    def test_translate_term_tool_with_select(self, module):
    ...
    def test_translate_lasso_tool(self, module):
        """測試 Lasso 翻譯"""
    ...
    def test_plugin_terms_not_override_app_terms(self, module):
        """測試外掛詞彙不會覆蓋主應用詞彙"""
...
class TestSelectToolEndToEnd:
    ...
    def test_select_tool_roundtrip(self, module):
        """測試「選取工具」雙向翻譯"""
        # 繁中 → 英文
    ...
    def test_search_returns_plugin_source(self, module):
        """測試搜尋結果包含外掛來源資訊"""
