...
class TestFrameworkVocabularyAccessor:
    ...
    def test_framework_path_exists(self, accessor):
        """測試 GlyphsCore.framework 路徑存在"""
        assert accessor.framework_path.exists()

    def test_discover_locales(self, accessor):
        """測試語系發現功能"""
    ...
    def test_discover_strings_files(self, accessor):
        """測試 .strings 檔案發現"""
    ...
    def test_get_all_terms_english(self, accessor):
        """測試取得英文詞彙"""
    ...
    def test_get_all_terms_chinese(self, accessor):
        """測試取得繁體中文詞彙"""
    ...
    def test_get_terms_from_file(self, accessor):
        """測試從特定檔案取得詞彙"""
    ...
    def test_custom_parameters_terms(self, accessor):
    ...
    def test_nonexistent_file(self, accessor):
        """測試不存在的檔案"""
...
class TestGlyphsCoreSpecificTerms:
    ...
    def test_panose_terms(self, accessor):
        """測試 PANOSE 詞彙"""
    ...
    def test_language_tags_terms(self, accessor):
        """測試語言標籤詞彙"""
    ...
    def test_categories_terms(self, accessor):
        """測試字元分類詞彙"""
    ...
    def test_scripts_terms(self, accessor):
        """測試書寫系統詞彙"""
    ...
    def test_inspector_terms(self, accessor):
        """測試 Inspector 相關詞彙"""
    ...
    def test_feature_names_translation(self, accessor):
